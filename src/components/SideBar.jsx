    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <Image
          ...
          src={
            userData?.profile_picture ? userData?.profile_picture : defaultImage
          }
        />
      ...
      <div className="mt-8 flex flex-col gap-y-6">
        ...
        <div className="flex cursor-pointer items-center gap-x-4 rounded-lg px-3 py-2 hover:bg-background">
          ...
          <p className="tooltip">
            My Appointment <span className="tooltiptext">Coming soon</span>
          </p>
        </div>
        <div className="flex cursor-pointer items-center gap-x-4 rounded-lg px-3 py-2 hover:bg-background">
          <Image src={paymentMethod} />
          <p className="tooltip">Payment Method <span className="tooltiptext">Coming soon</span></p>
        </div>
        <div
        ...
        <div className="flex cursor-pointer items-center gap-x-4 rounded-lg px-3 py-2 hover:bg-background">
          ...
          <p className="tooltip">Help Center <span className="tooltiptext">Coming soon</span></p>
        </div>
      </div>
    </aside>
  );
